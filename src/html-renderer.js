...
class HtmlRenderer {
  _loadPage(client, html, options, config) {
    /**
    ...
    return new Promise(async(resolve, reject) => {
      ...
      // Set document content to submitted html
  ...
  captureScreenshot(html, options, config) {
    return new Promise(async(resolve, reject) => {
      ...
      try {
        await this._loadPage(client, html, options, config);
